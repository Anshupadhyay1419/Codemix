          ...
          {TABS.map(t => (
            <button key={t.id} onClick={() => setActiveTab(t.id)}
              style={{
                ...
                border: activeTab === t.id ? "1px solid rgba(139,92,246,0.25)" : "1px solid transparent",
                background: activeTab === t.id ? "linear-gradient(135deg, rgba(124,58,237,0.3), rgba(79,70,229,0.3))" : "transparent",
                color: activeTab === t.id ? "#c4b5fd" : "#475569",
              }}>
